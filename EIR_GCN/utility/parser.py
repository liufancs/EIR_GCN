...
def parse_args():
    parser = argparse.ArgumentParser(description="Run EIR_GCN.")
    ...
    parser.add_argument('--dataset', nargs='?', default='KS',
                        help='Choose a dataset from KS, Home_and_Kitchen, Movies, Toys_and_Games}')
    ...
    parser.add_argument('--model_type', nargs='?', default='EIR_GCN',
                        help='Specify the name of model (EIR_GCN).')
    parser.add_argument('--adj_type', nargs='?', default='norm',
                        help='Specify the type of the adjacency (laplacian) matrix from {plain, norm, mean}.')
    parser.add_argument('--alg_type', nargs='?', default='EIR_GCN',
